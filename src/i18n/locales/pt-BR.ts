...
const ptBR: DemoMessages = {
  ...
  codeHint: "Código curto e único (ex. ENG)",
  locationHint: "Localização física ou prédio",
  managerHint: "Gerente do departamento",
  employeeCountHint: "Número de funcionários",
